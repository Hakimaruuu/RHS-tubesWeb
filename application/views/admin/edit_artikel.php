                          ...
                          <div class="row row-1">
                            ...
                            <div class="col-11"> 
                             ...
                             <div class="input-group mb-3"><h5>Isikan link menuju gambar utama anda :</h5><br>
                               <div class="col-12">
                                 <input placeholder="<?php echo $artikel['gambar']; ?>" name="gambar" type="text" class="form-control" placeholder="Link untuk gambar utama" aria-label="" aria-describedby="basic-addon1"><br>
                               </div>
